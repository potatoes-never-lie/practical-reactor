...
public class c5_CreatingSequence {
    ...
    public void interval() {
        Flux<Long> interval = Flux.fromIterable(Arrays.asList(0L, 1L, 2L)).delayElements(Duration.ofMillis(1000));
    ...
    public void repeat() {
        ...
        counter.incrementAndGet()).repeat(9);
